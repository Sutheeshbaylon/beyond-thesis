...
export async function uploadStaffDeliverable(formData: FormData, role: 'writer' | 'stats') {
  ...
  if (!ALLOWED_TYPES.includes(ext)) throw new Error(`File type .${ext} is not allowed.`)

  // Get client name for file naming
